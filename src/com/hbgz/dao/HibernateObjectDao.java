...
public class HibernateObjectDao extends BaseDao
{
	...
	public List<RegisterOrderT> qryRegisterOrderTs(String userId)
	{
		...
		String hql = "from RegisterOrderT as model where model.orderState='000' and model.state='00A' and model.userId=? and to_date(substr(register_time, 0, 10)||' 23:59:59', 'yyyy-mm-dd hh24:mi:ss')>=sysdate order by subStr(register_time,0,10) desc";
