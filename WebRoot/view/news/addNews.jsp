		...
		<form action="/mobile.htm?method=addNewsFile" method="post" enctype="multipart/form-data">
			<table width="50%" border="1" cellspacing="0" cellpadding="0" align='center'>
				...
				<tr>
					...
					<td>
						<input name="newsTitle" class="subtext" type="text" />
					</td>
				</tr>
				<tr>
					<td align='center'>选择图片</td>
					<td>
						<input type="file" class="subtext2" name="image" />
					</td>
				</tr>
				<tr>
					<td align='center'>文章内容</td>
					<td>
						<input type="file" class="subtext2" name="txt" />
					</td>
				</tr>
			</table>
