						...
						<td style='word-break:break-all;'>
							<fieldset style='width:380px; margin-top: 4px auto; margin-bottom: 10px; text-align: left;'>
								...
								<c:if test="${ques.recordType == 'ask' || ques.recordType == 'copy' }">
									<img src='/images/ask.png' height='25' width='30' style='vertical-align: top;margin-top: 5px'/>&nbsp;&nbsp;<textarea rows='4' cols='51' style='border: 0;height:50px;overflow:auto;margin-top: 5px' readonly="readonly">${ques.content }</textarea>
								</c:if>
