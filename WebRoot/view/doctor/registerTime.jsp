	...
	<div id="template" style="height:700px;overflow:auto">
		...
		<table width="50%" border="1" cellspacing="0" cellpadding="0" align="center"
			...
			<tr class="tabletop">
				...
				<td align="center" width="20%">选择<input type='checkbox' name="all"  id='all'  /></td>
			</tr>
				...
				<tr>
					...
					<td align="center"><input type='checkbox' name="checkbox"  id='day1' registerWeek='一' dayType='上午'  /></td>		
				</tr>
				<tr>
					<td align="center" width='15%'>周一</td>
					...
					<td align="center"><input type='checkbox' name="checkbox"  id='day2' registerWeek='一' dayType='下午'  /></td>		
				</tr>
				...
				<tr>
					...
					<td align="center"><input type='checkbox' name="checkbox"  id='day3' registerWeek='二' dayType='上午'  /></td>		
				</tr>
				<tr>
					<td align="center" width='15%'>周二</td>
					<td align="center">下午</td>
					
					<td align="center"><input type='checkbox' name="checkbox"  id='day4' registerWeek='二' dayType='下午'  /></td>		
				</tr>
				...
				<tr>
					...
					<td align="center"><input type='checkbox' name="checkbox" id='day5' registerWeek='三' dayType='上午'  /></td>		
				</tr>
				<tr>
					<td align="center" width='15%'>周三</td>
					<td align="center">下午</td>
					
					<td align="center"><input type='checkbox' name="checkbox"  id='day6' registerWeek='三' dayType='下午'  /></td>		
				</tr>
				...
				<tr>
					...
					<td align="center"><input type='checkbox' name="checkbox"  id='day7' registerWeek='四' dayType='上午'  /></td>		
				</tr>
				<tr>
					<td align="center" width='15%'>周四</td>
					<td align="center">下午</td>
					
					<td align="center"><input type='checkbox' name="checkbox"  id='day8' registerWeek='四' dayType='下午'  /></td>		
				</tr>
				...
				<tr>
					...
					<td align="center"><input type='checkbox' name="checkbox"  id='day9' registerWeek='五' dayType='上午'  /></td>		
				</tr>
				<tr>
					<td align="center" width='15%'>周五</td>
					<td align="center">下午</td>
					
					<td align="center"><input type='checkbox' name="checkbox"  id='day10' registerWeek='五' dayType='下午'  /></td>		
				</tr>		
		</table>
	<br/>
			<table width="50%" border="1" cellspacing="0" cellpadding="0" align='center'
